...
export const POSITION_PRESETS = {
  ...
  LB: { label: 'LB', broadPosition: 'DEF', section: 'DEF', xPercent: 10, yPercent: 76 },
  ...
  RB: { label: 'RB', broadPosition: 'DEF', section: 'DEF', xPercent: 90, yPercent: 76 },
  LWB: { label: 'LWB', broadPosition: 'DEF', section: 'DEF', xPercent: 8, yPercent: 64 },
  RWB: { label: 'RWB', broadPosition: 'DEF', section: 'DEF', xPercent: 92, yPercent: 64 },

  LDM: { label: 'LDM', broadPosition: 'MID', section: 'MID', xPercent: 38, yPercent: 60 },
  CDM: { label: 'CDM', broadPosition: 'MID', section: 'MID', xPercent: 50, yPercent: 60 },
  RDM: { label: 'RDM', broadPosition: 'MID', section: 'MID', xPercent: 62, yPercent: 60 },
  LM: { label: 'LM', broadPosition: 'MID', section: 'MID', xPercent: 10, yPercent: 47 },
  ...
  RM: { label: 'RM', broadPosition: 'MID', section: 'MID', xPercent: 90, yPercent: 47 },
  LAM: { label: 'LAM', broadPosition: 'MID', section: 'MID', xPercent: 30, yPercent: 32 },
  CAM: { label: 'CAM', broadPosition: 'MID', section: 'MID', xPercent: 50, yPercent: 30 },
  RAM: { label: 'RAM', broadPosition: 'MID', section: 'MID', xPercent: 70, yPercent: 32 },

  LW: { label: 'LW', broadPosition: 'FWD', section: 'FWD', xPercent: 15, yPercent: 16 },
  LST: { label: 'LST', broadPosition: 'FWD', section: 'FWD', xPercent: 35, yPercent: 10 },
  ST: { label: 'ST', broadPosition: 'FWD', section: 'FWD', xPercent: 50, yPercent: 8 },
  RST: { label: 'RST', broadPosition: 'FWD', section: 'FWD', xPercent: 65, yPercent: 10 },
  RW: { label: 'RW', broadPosition: 'FWD', section: 'FWD', xPercent: 85, yPercent: 16 },
  CF: { label: 'CF', broadPosition: 'FWD', section: 'FWD', xPercent: 50, yPercent: 16 },
};
