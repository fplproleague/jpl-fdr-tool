  ...
  return (
    <div style={{
      ...
      <p style={{ color: '#8F79AD', fontSize: '12px', margin: '0 0 12px' }}>
        Upload een screenshot van je bestaande FPL-team (Transfers-weergave). We stellen een herkenning voor die je kan nakijken en corrigeren — er wordt pas iets ingevuld nadat je dat bevestigt.
      </p>
